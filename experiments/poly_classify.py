import former
from former import util, polytransformers
...
def go(arg):
    """
    Creates and trains a polynomial transformer for the IMDB sentiment classification task.
    """
    ...
    # Create the polynomial transformer model
    model = polytransformers.PolyCTransformer(
...
if __name__ == "__main__":
    ...
    # Added polynomial network specific arguments
    parser.add_argument("--degree", dest="degree",
                        help="Polynomial degree (for polynomial networks)",
                        default=2, type=int)

    parser.add_argument("--poly-class", dest="poly_class",
                        help="Polynomial class to use",
                        default="CP", type=str)

    parser.add_argument("--use-relu", dest="use_relu",
                        help="Use ReLU between polynomial layers",
                        action="store_true")
